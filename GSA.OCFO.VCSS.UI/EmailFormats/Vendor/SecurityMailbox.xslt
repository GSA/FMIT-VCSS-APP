  ...
  <xsl:template match="Request">
    ...
    <div style="min-width:650px;max-width:800px;padding:5px 10px 5px 10px;background:#f4f4f4;text-align:left;">
      ...
      <div style="padding:10px; background:#f9f9f9; border: 1px solid #cccccc;">
        ...
        <p>
          If the Account Administrator(s) <b><u>disapproves</u></b> this Request, then forward the disapproval response to the Requester and indicate they will not be granted Access to this Account in VCSS.
        </p>
        <p>
          If the Account Administrator(s) <b><u>approves</u></b> this Request, then forward the approval response to the Requester and use the information below to add the User to VCSS.
        </p>
        <p>
