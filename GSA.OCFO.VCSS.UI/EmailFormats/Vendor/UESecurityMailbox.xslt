...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="Request">
    <div style="min-width:650px;max-width:800px;padding:5px 10px 5px 10px;background:#f4f4f4;">
      ...
      <div style="padding:10px; background:#f9f9f9; border: 1px solid #cccccc;">
        ...
        <p>A User has requested to Update Email in VCSS and submitted the following</p>
        <p>
        ...
        <div style="border:1px solid Black; padding:10px;">
          <p>
            ...
            New Email : <xsl:value-of select="UserInfo/NewEmailAddress"/><br/>
